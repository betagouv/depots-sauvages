    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ds_numero_dossier", models.IntegerField(unique=True, verbose_name="numéro DS")),
                (
                    "ds_date_depot",
                    models.DateTimeField(blank=True, null=True, verbose_name="date de dépôt DS"),
                ),
                (
                    "ds_date_modification",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="date modification DS"
                    ),
                ),
            ],
            options={
