<template>
  <PremiumBox
    ...
    description="Vous n'avez pas encore créé de constatation pour initier une procédure administrative de lutte contre les dépôts sauvages."
  ...
  >
    <template #actions>
      ...
      <button class="fr-btn fr-btn--secondary" @click="openSimulator">
