    ...
    <div class="fr-tabs" style="box-shadow: none">
      ...
      >
        ...
        <div class="fr-mb-4w">
          ...
          >
            Cibles prioritaires de l'équipe produit d'ici au 31 décembre 2026.
          </p>
          <div class="fr-grid-row fr-grid-row--gutters">
            <div v-for="(okr, key) in store.stats.okrs" :key="key" class="fr-col-12 fr-col-md-4">
              <div
        ...
        <h3 class="fr-h5 fr-mt-4w" style="display: flex; align-items: center; gap: 0.5rem">
          <span class="fr-icon-table-line fr-text-title-blue-france" aria-hidden="true"></span>
          Suivi Hebdomadaire (Réunion d'équipe Déploiement)
        </h3>
        <p
          class="fr-text--sm"
          style="color: var(--text-mention-grey); margin-top: -0.5rem; margin-bottom: 1.5rem"
        >
          Données d'activité de la cellule de déploiement, actualisées toutes les semaines (Grist).
        </p>
        <div class="bo-table-container">
          <table class="bo-table">
            <thead>
            ...
            <tbody>
              <tr v-for="snapshot in store.stats.weeklySnapshots" :key="snapshot.date">
                <td>
